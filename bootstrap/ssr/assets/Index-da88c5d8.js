...
import "sweetalert2";
import "classnames";
function CardTableRoles({ color = "light", roles, className = "", meta, labelLinks }) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "rounded-t mb-0 px-4 py-3 border-0", children: /* @__PURE__ */ jsxs("div", { className: "text-center flex justify-between", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-blueGray-700 text-lg font-bold uppercase " + (color === "light" ? "text-blueGray-700" : "text-white"), children: "Roles" }),
          /* @__PURE__ */ jsx(LinkButton, { theme: "blue", href: route("admin.roles.create"), children: "New Role" })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "items-center w-full bg-transparent border-collapse", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: roles.map(({ id, name, permissions }, index) => /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2", children: /* @__PURE__ */ jsx("div", { children: permissions.map((v, i) => /* @__PURE__ */ jsxs("span", { children: [
              i > 0 ? ", " : "",
              v.name
            ] }, i)) }) }),
            /* @__PURE__ */ jsx("td", { className: "border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2 ", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-start gap-1 ", children: [
              /* @__PURE__ */ jsx(Link, { href: route("admin.roles.edit", id), className: "text-lightBlue-500 background-transparent font-bold px-3 py-1 text-xs outline-none focus:outline-none hover:text-lightBlue-100 hover:scale-105 mr-1 mb-1 ease-linear transition-all duration-150", type: "button", children: "Edit" }),
              /* @__PURE__ */ jsx(
                "button",
                {
...
const Index = ({ roles }) => {
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsx(CardTableRoles, { color: "dark", roles: data, meta, labelLinks: links }) });
};
export {
  Index as default
};
