    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "items-center w-full bg-transparent border-collapse", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: users.map(({ id, name, email }, index) => /* @__PURE__ */ jsxs("tr", { children: [
...
const Index = ({ users }) => {
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsx(CardTableUsers, { color: "dark", users: data, meta, labelLinks: links }) });
};
export {
  Index as default
};
