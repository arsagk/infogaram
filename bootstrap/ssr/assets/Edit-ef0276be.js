...
import CardPermohonan from "./CardPermohonan-8f262646.js";
...
const CardDkeluarbiayapermuserList = ({ keluarbiayapermuser }) => {
  const { dkeluarbiayapermusers: { data, links, meta } } = usePage().props;
  const handleRemoveData = (id) => {
    router.delete(route("staf.transaksi.dkeluarbiayapermusers.destroy", id));
  };
  return /* @__PURE__ */ jsxs("div", { className: "w-full mt-4 flex flex-col mb-2", children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "list-none container-snap max-h-80 overflow-x-hidden rounded-b-md shadow-md", children: data && data.map((item, index) => /* @__PURE__ */ jsx("li", { className: "w-full flex flex-col overflow-hidden bg-lightBlue-300", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full gap-1 text-xs px-2 py-0 items-center justify-start text-lightBlue-900 border-b-2 border-lightBlue-200", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "pb-1 w-[5%] flex justify-center items-center gap-2", children: /* @__PURE__ */ jsx("button", { disabled: keluarbiayapermuser.status_keluarbiayapermuser == "approved", onClick: (e) => useSwal.confirm({
        title: "Hapus Data",
    ...
    /* @__PURE__ */ jsx("ul", { className: "list-none container-snap max-h-80 overflow-x-hidden rounded-b-md shadow-md", children: /* @__PURE__ */ jsxs("li", { className: "w-full flex flex-col overflow-hidden bg-lightBlue-600 px-2 py-1  font-semibold text-lightBlue-50", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex w-full gap-1 text-xs px-2 py-1 items-center justify-start border-b-2 border-lightBlue-500", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-[15%] text-right", children: keluarbiayapermuser.jumlah_biaya }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex w-full gap-1 text-xs px-2 py-1 items-center justify-start border-b-2 border-lightBlue-500", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-[15%] text-right", children: keluarbiayapermuser.saldo_awal }),
        /* @__PURE__ */ jsx("div", { className: "w-[5%] flex justify-start items-center gap-2" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex w-full gap-1 text-xs px-2 py-1 items-center justify-start border-b-2 border-lightBlue-500", children: [
        /* @__PURE__ */ jsx("div", { className: "w-[60%]" }),
        /* @__PURE__ */ jsx("div", { className: "hidden md:block md:w-[20%] text-right", children: "Sisa Saldo" }),
        /* @__PURE__ */ jsx("div", { className: "w-[15%] text-right", children: keluarbiayapermuser.saldo_akhir }),
        /* @__PURE__ */ jsx("div", { className: "w-[5%] flex justify-start items-center gap-2" })
      ] })
    ] }) }),
...
const Create = ({ keluarbiayapermuser, itemkegiatanOpts, status_keluarbiayapermusers, is_admin, base_route }) => {
  var _a, _b;
  const selStatusKeluarbiayapermuser = status_keluarbiayapermusers.find((item) => item.value == keluarbiayapermuser.status_keluarbiayapermuser);
  ...
  function handleUpdateStatus(e) {
    ...
    router.put(route(base_route + "transaksi.keluarbiayapermusers.status.update", keluarbiayapermuser.id), data2, {
      onSuccess: (e2) => {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    post(
      route(base_route + "transaksi.keluarbiayapermusers.update", keluarbiayapermuser.id),
      {
        onSuccess: () => {
          reset();
  ...
  return /* @__PURE__ */ jsxs(StafLayout, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex content-center items-center justify-center relative -top-2", children: /* @__PURE__ */ jsx("div", { className: "w-full lg:w-11/12 px-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col min-w-0 break-words w-full mb-2 shadow-lg shadow-slate-400 rounded-lg bg-blueGray-100 border-0", children: [
      /* @__PURE__ */ jsx("div", { className: "rounded-t mb-1 px-4 py-2 ", children: /* @__PURE__ */ jsxs("div", { className: "w-full grid grid-cols-1 md:grid-cols-2 bg-lightBlue-800 text-lightBlue-100 px-4 py-2 shadow-md rounded-lg", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-left md:text-right", children: moment(keluarbiayapermuser.created_at, "DD MMM YYYY hh:mm").format("DD MMM YYYY hh:mm") })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex-auto px-4 lg:px-6 py-4 pt-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-2", children: [
          /* @__PURE__ */ jsx(Input, { name: "instansi", label: "Instansi", disabled: true, defaultValue: (_a = keluarbiayapermuser.instansi) == null ? void 0 : _a.nama_instansi }),
          /* @__PURE__ */ jsx(Input, { name: "metodebayar", label: "Metode Bayar", disabled: true, defaultValue: (_b = keluarbiayapermuser.metodebayar) == null ? void 0 : _b.nama_metodebayar }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "mb-2 font-bold text-xs", children: "KASBON" }),
            /* @__PURE__ */ jsx("div", { className: "px-2 py-2 rounded text-sm bg-blueGray-200 text-blueGray-600", children: keluarbiayapermuser.kasbons.length > 0 ? keluarbiayapermuser.kasbons.map((e, i) => /* @__PURE__ */ jsxs("span", { children: [
              e.id,
              ":",
              e.jumlah_kasbon
        ...
        keluarbiayapermuser && keluarbiayapermuser.status_keluarbiayapermuser == "wait_approval" ? /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs("div", { className: "w-full grid grid-cols-2 gap-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "w-full grid grid-cols-1", children: [
            /* @__PURE__ */ jsx(
              PermohonanSelect,
              {
                ...
                onValueChange: (e) => {
                  setData((v) => ({ ...v, "permohonan": e, "transpermohonan_id": e.transpermohonan.id }));
                }
              }
            ),
          ...
          /* @__PURE__ */ jsx("div", { className: "w-full flex items-start", children: /* @__PURE__ */ jsx(CardPermohonan, { permohonan: data.permohonan }) })
        ] }) }) : /* @__PURE__ */ jsx(Button, { disabled: !is_admin, theme: "blueGrey", className: "py-2 text-sm text-blueGray-500", onClick: (e) => {
          e.preventDefault();
          setShowStatusDialog(true);
        }, children: /* @__PURE__ */ jsx("span", { children: keluarbiayapermuser.status_keluarbiayapermuser }) }),
        /* @__PURE__ */ jsx("div", { className: "w-full flex items-start", children: /* @__PURE__ */ jsx(CardDkeluarbiayapermuserList, { keluarbiayapermuser }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsx(Button, { disabled: parseInt(keluarbiayapermuser.jumlah_biaya) == 0, theme: "blue", onClick: (e) => prosesLaporan(e), children: /* @__PURE__ */ jsx("span", { children: "Cetak" }) })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsx(ModalCetakLaporan, { showModal: showModalLaporan, setShowModal: setShowModalLaporan, src: route(base_route + "transaksi.keluarbiayapermusers.lap.staf", keluarbiayapermuser.id) }),
