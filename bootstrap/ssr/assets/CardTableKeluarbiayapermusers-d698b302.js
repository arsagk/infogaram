...
function CardTableKeluarbiayapermusers({ color = "light", keluarbiayapermusers, className = "", meta, labelLinks }) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "rounded-full mb-0 px-4 py-3 border-0 ", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between w-full flex-col md:flex-row", children: [
          /* @__PURE__ */ jsx("div", { className: "relative w-full max-w-full flex-grow flex-1 ", children: /* @__PURE__ */ jsx(
            "h3",
            {
              ...
              children: "PENGELUARAN BIAYA PERMOHONAN"
            }
          ) }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-2 flex-row items-start", children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                theme: "blue",
                href: route(base_route + "transaksi.keluarbiayapermusers.create"),
        ...
        /* @__PURE__ */ jsx("div", { className: "block w-full overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "items-center w-full bg-transparent border-collapse", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: keluarbiayapermusers.map(({ id, created_at, instansi, metodebayar, kasbons, user: user2, status_keluarbiayapermuser }, index) => /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-1", children: status_keluarbiayapermuser }),
            /* @__PURE__ */ jsx("td", { className: "border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-1 ", children: /* @__PURE__ */ jsx(
              Link,
              {
                href: route(base_route + "transaksi.keluarbiayapermusers.edit", id),
...
export {
  CardTableKeluarbiayapermusers as C
};
