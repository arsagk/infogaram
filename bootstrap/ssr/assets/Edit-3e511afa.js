...
const Edit = () => {
  ...
  const { permohonan, permohonanUsers, jenishaks, jenispermohonans, desa, jenishak, permohonanJenispermohonans } = usePage().props;
  const jenistanah = jenisTanahOptions.find((v) => v.value === permohonan.jenis_tanah);
  ...
  const getDesaOptions = async (query) => {
    const res = await myapp.backend.get(`/admin/desas/api/list/?query=${query}`);
    const data2 = res.data;
    data2.map((d) => ({
      value: d["id"],
      label: d["labelOption"]
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsx("div", { className: "flex content-center items-center justify-center h-full", children: /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/3 px-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg shadow-slate-400 rounded-lg bg-blueGray-200 border-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-t mb-0 px-6 py-4", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-3", children: /* @__PURE__ */ jsx("h6", { className: "text-blueGray-500 text-lg font-bold", children: "Edit Permohonan" }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-auto px-4 lg:px-10 py-10 pt-0", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsx(Input, { ref: firstInput, focused: true, name: "nama_pelepas", label: "Nama Pelepas", errors: errors.nama_pelepas, value: data.nama_pelepas, type: "text", onChange: (e) => setData("nama_pelepas", e.target.value) }),
      /* @__PURE__ */ jsx(Input, { name: "nama_penerima", label: "Nama Penerima", errors: errors.nama_penerima, value: data.nama_penerima, onChange: (e) => setData("nama_penerima", e.target.value) }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap ", children: [
        /* @__PURE__ */ jsx(
          SelectSearch,
          {
            ...
            onChange: (e) => setData({ ...data, jenishak_id: e ? e.value : "", jenishak: e ? e : {} })
          }
        ),
        /* @__PURE__ */ jsx(
          Input,
        ...
        ((_a = data.jenishak) == null ? void 0 : _a.label.toLowerCase()) === "hak milik adat" ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(
            Input,
            {
              ...
              value: data.persil,
              type: "text",
              onChange: (e) => setData("persil", e.target.value)
            }
          ),
          /* @__PURE__ */ jsx(
            InputWithMask,
            {
              ...
              onChange: (e) => setData("klas", e.target.value)
            }
          )
        ] }) : null,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap md:flex-nowrap gap-1 ", children: [
        ...
        /* @__PURE__ */ jsx(Input, { name: "atas_nama", label: "Atas Nama", errors: errors.atas_nama, value: data.atas_nama, type: "text", onChange: (e) => setData("atas_nama", e.target.value) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2 flex-wrap md:flex-nowrap", children: [
          ...
          SelectSearch,
          {
            ...
            onChange: (e, option) => {
              if (option.removedValue && option.removedValue.isFixed)
                return;
              setData({ ...data, jenispermohonans: e ? e : {} });
            },
        ...
        /* @__PURE__ */ jsx(
          SelectSearch,
          {
            ...
            onChange: (e) => setData({ ...data, jenis_tanah: e ? e.value : "", jenistanah: e ? e : {} })
          }
        )
      ] }),
      data.jenispermohonans && data.jenispermohonans.length ? /* @__PURE__ */ jsx(ListCheckbox, { list: data.jenispermohonans, onItemChange: (e) => setSelectedJenisPermohonan(e) }) : null,
      /* @__PURE__ */ jsx(
        AsyncSelectSearch,
        {
          name: "desa",
          ...
          isClearable: true,
          label: "Desa",
          onChange: (e) => setData({ ...data, desa_id: e ? e.value : "", desa: e ? e : {} }),
          value: data.desa,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx(LinkButton, { theme: "blueGrey", href: route("admin.permohonans.index"), children: /* @__PURE__ */ jsx("span", { children: "Kembali" }) }),
        /* @__PURE__ */ jsx(
          LoadingButton,
          {
            theme: "black",
