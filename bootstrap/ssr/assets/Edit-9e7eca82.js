...
const Edit = () => {
  const { grupitemkegiatanOpts, selGrupitemkegiatanOpts, itemkegiatan, instansiOpts, selInstansiOpt, akunOpts, selAkunOpt } = usePage().props;
  const { data, setData, errors, post, processing } = useForm({
    nama_itemkegiatan: itemkegiatan.nama_itemkegiatan || "",
    instansi_id: itemkegiatan.instansi_id || "",
    instansi: selInstansiOpt || void 0,
    akun_id: itemkegiatan.akun_id || "",
    akun: selAkunOpt || void 0,
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsx("div", { className: "flex content-center items-center justify-center h-full", children: /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/4 px-4", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg shadow-slate-400 rounded-lg bg-blueGray-200 border-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-t mb-0 px-6 py-2", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-2", children: /* @__PURE__ */ jsx("h6", { className: "text-blueGray-500 text-lg font-bold", children: "Edit Item Kegiatan" }) }),
