...
class StafController extends Controller
{
    ...
    public function index()
    {
        ...
        // });
        $traffics =[
            ['nama_jenispermohonan'=>'Jual Beli', 'jumlah'=>200, 'percentage'=>'20', 'bg_color'=>trim($this->random_hex_color())],
        ...
        return Inertia::render('StafDashboard', ['traffics' => $traffics, 'recentActivities' => []]);
    }
}
